...
/**
 * Tests the public API of {@link WallpaperInstance}. This is a subset of the tests in
 * frameworks/base/core/tests/coretests/src/android/app/wallpaper/WallpaperInstanceTest.java.
 */
...
public class WallpaperInstanceTest {
    ...
    public void id_fromDescription() throws Exception {
        ...
        WallpaperInstance instance =
                new WallpaperInstance(
                        makeWallpaperInfo(), new WallpaperDescription.Builder().setId(id).build());
    ...
    public void id_fromComponent() throws Exception {
        ...
        WallpaperInstance instance =
                new WallpaperInstance(info, new WallpaperDescription.Builder().build());
    ...
    public void id_default() {
        WallpaperInstance instance =
                new WallpaperInstance(null, new WallpaperDescription.Builder().build());
    ...
    public void parcel_roundTripSucceeds() throws Exception {
        WallpaperInstance source =
                new WallpaperInstance(
                        makeWallpaperInfo(), new WallpaperDescription.Builder().build());
