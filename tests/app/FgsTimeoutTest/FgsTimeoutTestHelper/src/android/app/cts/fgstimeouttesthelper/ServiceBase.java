...
public abstract class ServiceBase extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        final FgsTimeoutMessage incoming = FgsTimeoutHelper.getMessage(intent);
        ...
        FgsTimeoutHelper.sendBackMethodName(this.getClass(), "onStartCommand", (m) -> {
    ...
    public void onDestroy() {
        ...
        FgsTimeoutHelper.sendBackMethodName(this.getClass(), "onDestroy");
    }
    ...
    public IBinder onBind(Intent intent) {
        ...
        FgsTimeoutHelper.sendBackMethodName(this.getClass(), "onBind");
    ...
    public void onTimeout(int startId) {
        ...
        FgsTimeoutHelper.sendBackMethodName(this.getClass(), "onTimeout", (m) -> {
            m.setServiceStartId(startId);
        });
    }
    ...
    public void onTimeout(int startId, int fgsType) {
        Log.i(TAG, "onTimeout: " + this.getClass().getName()
                + " startId=" + startId + " fgsType=" + fgsType);

        FgsTimeoutHelper.sendBackMethodName(this.getClass(), "onTimeout", (m) -> {
            m.setServiceStartId(startId);
            m.setFgsType(fgsType);
        });
    }
}
