...
public class SetBlobVisibilityRequestCtsTest {
    ...
    public void testBuildAndGet() {
        ...
        SetBlobVisibilityRequest request =
        ...
        assertThat(request.getNamespacesNotDisplayedBySystem()).containsExactly("namespace1");
    ...
    public void testRebuild() {
        ...
        SetBlobVisibilityRequest.Builder builder =
                new SetBlobVisibilityRequest.Builder()
                        .setNamespaceDisplayedBySystem("namespace1", /* displayed= */ false)
                        .addNamespaceVisibleToConfig("namespace2", config1);
        ...
        SetBlobVisibilityRequest rebuild =
                builder.setNamespaceDisplayedBySystem("namespace3", /* displayed= */ false)
                        .addNamespaceVisibleToConfig("namespace4", config2)
                        .build();

        assertThat(original.getNamespacesNotDisplayedBySystem()).containsExactly("namespace1");
        ...
        assertThat(rebuild.getNamespacesVisibleToConfigs())
                .containsExactly(
                        "namespace2",
                        ImmutableSet.of(config1),
                        "namespace4",
                        ImmutableSet.of(config2));
    }
    ...
    public void testClearNamespaceVisibleToConfigs() {
        ...
        SetBlobVisibilityRequest request =
                new SetBlobVisibilityRequest.Builder()
                        ...
                        .addNamespaceVisibleToConfig("namespace1", config2)
                        .build();
