...
public class GenericDocumentCtsTest {
    ...
    public void testDocumentGetBlobHandleValue() throws Exception {
        ...
        assertThat((String[]) document.getProperty("stringKey1"))
                .asList()
                .containsExactly("test-value1");
        assertThat((AppSearchBlobHandle[]) document.getProperty("blobKey1"))
                .asList()
                .containsExactly(blobHandle1)
                .inOrder();
    }
    ...
    public void testDocumentGetArrayBlobHandleValues() throws Exception {
        ...
        assertThat(document.getPropertyStringArray("stringKey1"))
                ...
                .containsExactly("test-value1", "test-value2", "test-value3")
                .inOrder();
        assertThat(document.getPropertyBlobHandleArray("blobHandleKey1"))
                .asList()
                .containsExactly(blobHandle1, blobHandle2)
                .inOrder();
    }
    ...
    public void testDocumentInvalid_setNullBlobHandleValues() throws Exception {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () ->
                        builder.setPropertyBlobHandle(
                                "blobs", new AppSearchBlobHandle[] {blobHandle1, nullBlobHandle}));
    }
    ...
    public void testDocument_toBuilderWithBlobHandleValues() throws Exception {
        ...
        assertThat(document1.getPropertyBooleanArray("booleanKey1"))
                ...
                .inOrder();
        assertThat(document1.getPropertyLongArray("longKey2")).isNull();
        assertThat(document1.getPropertyBlobHandleArray("blobKey1"))
                .asList()
                .containsExactly(blobHandle1, blobHandle2)
                .inOrder();
    ...
    public void testDocumentGetPropertyNamesWithBlobHandleValue() throws Exception {
        ...
        GenericDocument document =
                new GenericDocument.Builder<>("namespace", "id1", "schemaType1")
                        ...
                        .build();
        assertThat(document.getPropertyNames())
                .containsExactly("longKey1", "doubleKey1", "booleanKey1", "stringKey1", "blobKey1");
    }
}
