 ...
 *
 * <p>Since the {@link ParcelFileDescriptor} sent to the client side from the local storage won't
 * cross the binder, we could revoke the {@link ParcelFileDescriptor} in the client side by directly
 * close the one in AppSearch side. This class just adding close listener to the inner {@link
...
public class JetpackAppSearchRevocableFileDescriptor extends ParcelFileDescriptor
    ...
    /**
     * Create a new ParcelFileDescriptor wrapped around another descriptor. By default all method
     * calls are delegated to the wrapped descriptor.
     */
    JetpackAppSearchRevocableFileDescriptor(
            @NonNull ParcelFileDescriptor parcelFileDescriptor, int mode) {
