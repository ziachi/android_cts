...
public final class ForegroundServiceUtil {
    ...
    public static void requestStartForegroundService(
            Context context, ComponentName name, Runnable serviceStarted, Runnable serviceStopped) {
                ...
                new Messenger(
                        new Handler(
                                ...
                                msg -> {
                                    ...
                                    Log.e(
                                            TAG,
                                            "Unknown message from the LocalMediaProjectionService: "
                                                    + msg.what);
                                    return false;
                                }));
        final Intent intent = new Intent().setComponent(name).putExtra(EXTRA_MESSENGER, messenger);
