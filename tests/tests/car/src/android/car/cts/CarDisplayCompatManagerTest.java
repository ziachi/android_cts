...
public class CarDisplayCompatManagerTest extends AbstractCarTestCase {
    @Rule
    ...
    public void testGetCarDisplayCompatManager() {
        mCarDisplayCompatManager =
                (CarDisplayCompatManager) getCar().getCarManager(Car.CAR_DISPLAY_COMPAT_SERVICE);
