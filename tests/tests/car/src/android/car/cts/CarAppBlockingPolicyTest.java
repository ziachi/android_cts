...
@SmallTest
public final class CarAppBlockingPolicyTest {
    ...
    public void testParcelling() throws Exception {
        ...
        AppBlockingPackageInfo selfInfo = AppBlockingPackageInfoTest.createInfoSelf(mContext);
        // this is only for testing parcelling. contents has nothing to do with actual app blocking.
        AppBlockingPackageInfo[] allowlists =
                new AppBlockingPackageInfo[] {carServiceInfo, selfInfo};
