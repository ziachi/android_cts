 ...
 */
package android.content.cts.packagechangedtestapp;
...
public class MainActivity extends Activity {
    private static final String TAG = "packagechangedtestapp.MainActivity";
    ...
    public void onResume() {
        ...
        if (remoteCallback != null) {
            ...
            Log.d(TAG, "call setComponentEnabledSetting");
