...
public class ADPFAtomTestDataProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        MatrixCursor cursor = new MatrixCursor(
                new String[]{CONTENT_COLUMN_KEY, CONTENT_COLUMN_VALUE});
        for (String key : mContentValues.keySet()) {
            cursor.addRow(new Object[]{key, mContentValues.get(key)});
        }
        return cursor;
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        assertEquals(uri.toString(), CONTENT_URI_STRING);
