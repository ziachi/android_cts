...
public class CVE_2024_43097 extends NonRootSecurityTestCase {

    @Test
    @AsbSecurityTest(cveBugId = 350118416)
    public void testPocCVE_2024_43097() {
        try {
            ...
            final List<String> functionNames = List.of("_ZN8SkRegion4OperERKS_S1_NS_2OpEPS_*");
            ...
            final String binaryName = "CVE-2024-43097";
            NativePoc.builder()
                    .pocName(binaryName)
