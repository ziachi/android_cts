...
public class CVE_2023_21085 extends NonRootSecurityTestCase {

    @AsbSecurityTest(cveBugId = 264879662)
    @Test
    public void testPocCVE_2023_21085() {
        try {
            final String binaryName = "CVE-2023-21085";
                    ...
                    new TombstoneUtils.Config()
                            ...
                            .setBacktraceIncludes(
                                    new BacktraceFilterPattern(
                                            "libnfc-nci.so", "nci_snd_set_routing_cmd"));
