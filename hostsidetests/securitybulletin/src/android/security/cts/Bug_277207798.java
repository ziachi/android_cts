...
public class Bug_277207798 extends NonRootSecurityTestCase {

    private static final String TEST_PKG = "android.security.cts.BUG_277207798_test";
    private static final String TEST_CLASS = "DeviceTest";
    private static final String TEST_METHOD = "testSetUnownedUriIconAsTarget";
    private static final String TEST_PROVIDER_APK = "Bug-277207798-provider.apk";
    private static final String TEST_APP_APK = "Bug-277207798-test.apk";

    @Test
    @AsbSecurityTest(cveBugId = 277207798)
    public void testBug_277207798() {
        ...
        try {
            ...
            Map<String, String> args = singletonMap(
                    "target_user",
                    Integer.toString(newUser));
            runDeviceTestsWithArgs(
                    TEST_PKG, TEST_PKG + "." + TEST_CLASS,
                    TEST_METHOD,
                    args);
        } catch (Exception e) {
            assumeNoException(e);
