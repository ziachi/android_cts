...
public class CVE_2022_23852 extends NonRootSecurityTestCase {

    // b/221255869
    // Vulnerability Behaviour: SIGABRT in self
    // Vulnerable Library: libexpat (As per AOSP code)
    // Vulnerable Function: XML_GetBuffer (As per AOSP code)
    @AsbSecurityTest(cveBugId = 221255869)
    @Test
    public void testPocCVE_2022_23852() {
        try {
            // Create the crash config
            String binary = "CVE-2022-23852";
            TombstoneUtils.Config crashConfig =
                    new TombstoneUtils.Config()
                            .setProcessPatterns(binary)
                            .setBacktraceIncludes(
                                    new BacktraceFilterPattern("libexpat", "XML_GetBuffer"))
