...
import com.android.bedstead.harrier.annotations.ParameterizedAnnotationScope.THEME
import com.android.bedstead.harrier.annotations.meta.ParameterizedAnnotation
import com.android.bedstead.nene.display.DisplayProperties

/** Parameterize a test so that it runs on device with dark mode OFF.  */
@Target(
...
@ParameterizedAnnotation(scope = THEME)
@EnsureUsingDisplayTheme(theme = DisplayProperties.Theme.LIGHT)
annotation class IncludeLightMode(
    /**
