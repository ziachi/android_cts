...
/** Query for a single key in a metadata. */
public interface MetadataKeyQuery<E extends Queryable> extends Queryable, Serializable, Parcelable {
    ...
    /**
     * The resource value of the key/
     */
    @CheckResult
    ResourceQuery<E> resourceValue();
