...
@RepeatingAnnotation
annotation class EnsureTestAppInstalledAsPrimaryDPCGroup(
    vararg val value: EnsureTestAppInstalledAsPrimaryDPC,
    /**
     ...
     */
    val priority: Int = EnsureTestAppInstalledAsPrimaryDPC.ENSURE_TEST_APP_INSTALLED_AS_PRIMARY_DPC_PRIORITY
)
